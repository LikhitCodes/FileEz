...
function createWindow() {
    mainWindow = new BrowserWindow({
        ...
        title: 'FileEz - P2P File Sharing System',
            ...
            submenu: [
                {
                    ...
                    click: () => {
                        dialog.showMessageBox(mainWindow, {
                            type: 'info',
                            title: 'About FileEz',
                            message: 'FileEz - P2P File Sharing System v1.0',
                            detail: 'A complete desktop application for secure peer-to-peer file sharing with modern dashboard and transfer history.'
                        })
                    }
                }
            ]
...
function loadDashboard() {
    ...
    mainWindow.setTitle('FileEz - Enhanced Dashboard')
}

function loadClassicInterface() {
    console.log('Loading backend server interface...')
    mainWindow.loadURL('http://127.0.0.1:8080')
    mainWindow.setTitle('FileEz - Backend Server Interface')
}
